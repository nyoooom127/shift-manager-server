...
public interface MongoUserRepository extends MongoRepository<User, String> {
  ...
  @Query(value = "{}", fields = "{'shifts': 0, 'constraints': 0}")
  List<User> findAllIncludeAllButShiftsAndConstraintsFields();

  @Query(value = "{authorizationData.username: '?0', authorizationData.password: '?1'}")
